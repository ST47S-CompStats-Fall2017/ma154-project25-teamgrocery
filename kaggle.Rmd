...
>>>>>>> c54469781eb4c239c949db5259bfd0f59c6016c8
}
...
# Run some model
<<<<<<< HEAD
model_cols <- c("unit_sales", "holiday", weekday_names, item_families, store_cities)
s_train_model <- s_train[,model_cols, with=FALSE]
rf_model <- train(unit_sales ~ . , data=s_train_model, method="rf",
=======
rf_model <- train(unit_sales ~
                    
                  , data=s_train, method="rf",
>>>>>>> c54469781eb4c239c949db5259bfd0f59c6016c8
